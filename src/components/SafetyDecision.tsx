  ...
  return (
    <section className="bg-white py-16 md:py-24 px-4 sm:px-6 overflow-hidden">
      <div className="max-w-3xl mx-auto">
        <FadeIn delay={0.1}>
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight leading-none text-gray-900 mb-12 text-center">
            Câu hỏi thường gặp
          </h2>
        </FadeIn>
        ...
        <div className="space-y-6 mb-16">
          <FadeIn delay={0.1}>
            <div className="border border-gray-200 rounded-xl p-6 bg-gray-50 hover:bg-white transition-colors hover:shadow-sm">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Q: Khoá học này dành cho ai?</h3>
          ...
          <FadeIn delay={0.2}>
            <div className="border border-gray-200 rounded-xl p-6 bg-gray-50 hover:bg-white transition-colors hover:shadow-sm">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Q: Tôi chưa biết gì về viết lách có học được không?</h3>
              <p className="text-gray-700 leading-relaxed">
          ...
          <FadeIn delay={0.3}>
            <div className="border border-gray-200 rounded-xl p-6 bg-gray-50 hover:bg-white transition-colors hover:shadow-sm">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Q: Tôi dốt tiếng Anh thì sao?</h3>
              <p className="text-gray-700 leading-relaxed">
          ...
          <FadeIn delay={0.4}>
            <div className="border border-gray-200 rounded-xl p-6 bg-gray-50 hover:bg-white transition-colors hover:shadow-sm">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Q: Học xong bao lâu thì kiếm được tiền?</h3>
              <p className="text-gray-700 leading-relaxed">
        ...
        <FadeIn delay={0.2} y={30}>
          <div className="bg-green-900 rounded-3xl p-8 md:p-12 text-center text-white shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl md:text-5xl font-black mb-6 leading-tight group-hover:scale-[1.02] transition-transform">
                Sẵn sàng trở thành <span className="text-green-300">Top 1%</span> AI Copywriter?
              </h2>
              <p className="text-xl text-green-100 mb-10 max-w-xl mx-auto leading-relaxed">
              ...
              <p className="text-xl text-green-100 mb-12 max-w-xl mx-auto leading-relaxed font-bold">
                Nó hoàn toàn có thể là sự thật.
              </p>
              
              <button className="bg-white outline-none text-green-900 font-black text-xl md:text-2xl px-12 py-5 rounded-2xl shadow-[0_10px_30px_rgba(255,255,255,0.2)] hover:bg-gray-100 transition-all transform hover:-translate-y-1 w-full sm:w-auto active:scale-95 hover:shadow-[0_15px_40px_rgba(255,255,255,0.3)] border-b-4 border-gray-300 hover:border-gray-200 active:border-t-4 active:border-b-0">
                ĐĂNG KÝ HỌC NGAY
              </button>
              <p className="mt-6 text-green-200 font-medium">Chỉ 499.000đ — Truy cập vĩnh viễn.</p>
            </div>
          </div>
        </FadeIn>
      </div>
